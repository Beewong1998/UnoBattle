  ...
  const patchData = [
    {
      updates: [
        ...
        "Added ability to skip the event page animation",
        "Event removal - Pick & Pray",
        "Bug Fix - No weird white space at the bottom of the screen if the event page was too big (For example if the player names or instructions were super long)",
      ],
      date: "20/07/24",
      version: "1.2.1",
    },
